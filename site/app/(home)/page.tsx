      ...
      <div className="flex border-b border-zinc-800">
        {installCommands.map((c, i) => (
          <button
            ...
            className={`flex-1 px-4 py-2.5 text-sm font-medium transition-all duration-200 ${active === i
    ...
    <div className="flex flex-col items-center w-full overflow-hidden text-zinc-100">
      ...
      <div ref={sponsorsSection.ref} className={`w-full max-w-5xl mx-auto px-4 py-16 transition-all duration-700 ${sponsorsSection.isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        ...
        <div className="flex justify-center gap-4">
          <a href={process.env.NEXT_PUBLIC_DONATION_URL || "#"} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-6 py-3 bg-violet-600 hover:bg-violet-500 text-white rounded-full font-semibold transition-all duration-300 hover:scale-105">
