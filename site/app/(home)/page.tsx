    ...
    <div className="flex flex-col items-center w-full overflow-hidden text-zinc-100">
      ...
      <div ref={heroRef} className="relative w-full max-w-7xl mx-auto px-4 pt-24 pb-20 md:pt-36 md:pb-28 flex flex-col items-center text-center z-10">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="absolute bottom-20 left-[30%] w-64 h-64 bg-cyan-500/8 rounded-full blur-3xl animate-float-1" />
        </div>

        <div className="mb-8 inline-flex items-center gap-2 px-4 py-2 rounded-full bg-violet-500/10 border border-violet-500/20 text-sm text-violet-300 animate-fade-up" style={{ animationDelay: '0.1s' }}>
          <Terminal className="w-4 h-4" />
          <span>Open-Source AI Coding Agent</span>
          <span className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse" />
        </div>

        <h1 className="text-5xl md:text-8xl font-bold tracking-tight mb-8 animate-fade-up" style={{ animationDelay: '0.3s' }}>
        ...
        {/* Install command */}
        <div className="mb-8 animate-fade-up opacity-0" style={{ animationDelay: '0.65s', animationFillMode: 'forwards' }}>
          <code className="px-6 py-3 bg-zinc-900/80 border border-zinc-800 rounded-xl text-violet-400 font-mono text-sm md:text-base">
      ...
      <div ref={statsSection.ref} className={`w-full max-w-5xl mx-auto px-4 py-16 transition-all duration-700 ${statsSection.isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            <div key={i} className="text-center p-6 rounded-2xl border border-zinc-800 bg-zinc-900/30">
      ...
      <div ref={modesSection.ref} className={`w-full max-w-5xl mx-auto px-4 py-16 transition-all duration-700 ${modesSection.isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {personas.map((p, i) => (
            <div key={i} className="p-4 rounded-xl border border-zinc-800 bg-zinc-900/30 hover:bg-zinc-900/60 hover:border-violet-500/30 transition-all">
      ...
      <div ref={featuresSection.ref} className={`w-full max-w-6xl mx-auto px-4 py-16 transition-all duration-700 ${featuresSection.isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {features.map((f, i) => (
            <div key={i} className="p-5 rounded-xl border border-zinc-800 bg-zinc-900/30 hover:border-violet-500/30 transition-all group">
