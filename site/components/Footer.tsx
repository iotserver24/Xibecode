        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href={process.env.NEXT_PUBLIC_DONATION_URL || "#"} target="_blank" rel="noopener noreferrer" className="text-violet-400 hover:text-violet-300 transition-colors">Donate</a></li>
