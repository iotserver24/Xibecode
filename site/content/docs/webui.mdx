...
<Callout type="info" title="Prefer a native app?">
The WebUI is also available as a [Desktop App](/docs/desktop) for Windows, macOS, and Linux — same interface, native window.
</Callout>
