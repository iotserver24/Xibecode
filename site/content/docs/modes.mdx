...
| `plan` | Aria the Architect | Planning, analysis | No |
...
**Persona:** Aria the Architect

Read-only mode for planning and analysis without modifications.

**Best For:** Understanding codebases, creating implementation plans, architectural analysis, risk assessment, technical documentation.

**Restrictions:** Cannot modify files, dry-run enabled by default.
