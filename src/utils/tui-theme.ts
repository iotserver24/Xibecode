/**
 * XibeCode TUI palette — aligned with OpenClaude dark theme tokens (semantic names
 * like `claude` are legacy keys; visually they are brand blues for XibeCode).
 */
export const darkTuiTheme = {
  autoAccept: 'rgb(175,135,255)',
  bashBorder: 'rgb(253,93,177)',
  claude: 'rgb(88,150,240)',
  claudeShimmer: 'rgb(138,185,250)',
...
export type TuiTheme = typeof darkTuiTheme;
export type TuiThemeColorKey = keyof TuiTheme;
