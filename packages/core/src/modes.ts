...
- If the user asks to browse, research visually, or "use the browser", write \`Computer: browser\` then open a page immediately so they can watch it in the Computer pane. When they should watch the shell instead, write \`Computer: terminal\`.
...
const TOOL_CATEGORIES: Record<string, ToolCategory> = {
  ...
  'get_context': 'context',
  'grep_code': 'read_only',
  'analyze_code_for_tests': 'read_only',
  'mine_project_patterns': 'read_only',
  ...
  'preview_app': 'shell_command',
  'run_tests': 'tests',
  'get_test_status': 'tests',
  'run_visual_test': 'tests',
  ...
  // MCP read tools
  'get_mcp_status': 'read_only',
  'mcp_list_prompts': 'read_only',
  'mcp_get_prompt': 'read_only',
  'mcp_list_resources': 'read_only',
  'mcp_read_resource': 'read_only',
  ...
  // Background tasks
  'start_background_task': 'shell_command',
  'check_background_task': 'read_only',
