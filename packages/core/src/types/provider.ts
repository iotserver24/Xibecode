...
export const PROVIDER_CONFIGS = {
 ...
 // ── More OpenAI-compat hosts () ──────────────────────────
  mistral: {
    ...
    description: 'Mistral / Codestral direct API',
  },
  together: {
    ...
    description: 'Open models inference API',
  },
  cerebras: {
  ...
  deepinfra: {
    ...
    description: 'Cheap open-model hosting',
  },
  upstage: {
    ...
    description: 'Solar models (OpenAI-compat)',
  },
  cohere: {
    ...
    description: 'Command R / OpenAI-compat endpoint',
  },
  perplexity: {
  ...
  'github-copilot': {
    ...
    format: 'openai',
    envKey: 'GITHUB_TOKEN',
    envKeys: ['COPILOT_GITHUB_TOKEN', 'GH_TOKEN'],
    name: 'GitHub Copilot',
    apiKeyUrl: 'https://github.com/settings/tokens',
    description: 'Copilot API (GITHUB_TOKEN / gh auth)',
  },
  nous: {
    ...
    description: 'Nous Portal — live /models (free + paid), Hermes Agent auth',
  },
  hermes: {
    baseUrl: 'https://inference-api.nousresearch.com/v1',
    defaultModel: 'deepseek/deepseek-v4-flash',
    ...
    envKeys: ['NOUS_API_KEY'],
    name: 'Hermes (alias of Nous)',
    apiKeyUrl: 'https://portal.nousresearch.com',
    description: 'Alias of nous',
  },
  bedrock: {
    baseUrl: '',
    defaultModel: 'anthropic.claude-sonnet-4-6',
 ...
 // Aliases (messaging gateway / models.dev id compatibility)
  kilo: {
    ...
    name: 'Kilo Code (alias)',
    apiKeyUrl: 'https://kilo.ai',
    description: 'Alias of kilocode',
  },
  'kimi-for-coding': {
    baseUrl: 'https://api.moonshot.ai/v1',
    defaultModel: 'kimi-k2.6',
    ...
    description: 'Alias of kimi-coding (models.dev id)',
  },
  opencode: {
    baseUrl: 'https://opencode.ai/zen/v1',
    defaultModel: 'claude-sonnet-4-5',
    ...
    envKey: 'OPENCODE_ZEN_API_KEY',
    name: 'OpenCode (alias)',
    description: 'Alias of opencode-zen',
  },
  gemini: {
    baseUrl: 'https://generativelanguage.googleapis.com/v1beta/openai',
  ...
  togetherai: {
    ...
    format: 'openai',
    envKey: 'TOGETHER_API_KEY',
    name: 'Together AI (alias)',
    description: 'Alias of together (models.dev id)',
  },
  'fireworks-ai': {
    baseUrl: 'https://api.fireworks.ai/inference/v1',
    defaultModel: 'accounts/fireworks/models/llama-v3p3-70b-instruct',
    format: 'openai',
    envKey: 'FIREWORKS_API_KEY',
    name: 'Fireworks (alias)',
    description: 'Alias of fireworks',
  },
  ...
  ollama: {
    ...
    description: 'Local Ollama OpenAI-compat (key often optional)',
  },
  lmstudio: {
