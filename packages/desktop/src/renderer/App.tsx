    ...
    <div className="flex h-screen flex-col bg-xibe-bg text-xibe-text font-sans overflow-hidden">
      ...
      <div className="flex flex-1 min-h-0 overflow-hidden relative">
        ...
        >
            ...
            <div className="shrink-0 p-3 border-t border-xibe-border/30 bg-xibe-surface/80 backdrop-blur-sm">
              <button
                onClick={() => setSettingsOpen(true)}
                className="flex w-full items-center gap-2.5 rounded-md px-3 py-2 text-[13px] font-medium text-xibe-text-secondary hover:bg-xibe-surface-hover hover:text-xibe-text transition-all duration-200 group border border-transparent hover:border-xibe-border/30"
              >
