...
export default function App() {
  ...
  const modeLabel = { agent: 'Agent', plan: 'Plan', review: 'Review' }[modeState.current] || modeState.current;

  return (
    <div className="flex h-screen flex-col bg-xibe-bg text-xibe-text font-sans">
      {/* Header */}
      <header className="flex items-center justify-between px-4 py-2 border-b border-xibe-border-subtle">
        <div className="flex items-center gap-3">
          ...
          <span className="text-[10px] text-xibe-text-dim/50 font-mono">{modeLabel}</span>
        </div>
