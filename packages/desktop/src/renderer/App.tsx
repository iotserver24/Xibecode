  ...
  return (
    <div className="flex h-screen flex-col bg-xibe-bg text-xibe-text font-sans overflow-hidden">
      ...
      <div className="flex flex-1 min-h-0 overflow-hidden relative">
        ...
        <aside
          className="shrink-0 bg-xibe-bg flex flex-col overflow-hidden transition-[width] duration-200 ease-in-out border-r border-xibe-border"
        ...
        >
            ...
            <div className="shrink-0 p-3 border-t border-xibe-border bg-xibe-bg/80 backdrop-blur-sm">
              <button
                onClick={() => setSettingsOpen(true)}
