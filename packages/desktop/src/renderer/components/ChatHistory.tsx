  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <div className="space-y-2.5 mb-5 shrink-0">
        <button
          onClick={onNewChat}
          className="flex w-full items-center gap-2.5 rounded-lg border border-transparent bg-transparent hover:bg-xibe-surface-hover/80 px-3 py-2.5 text-[13px] font-medium text-xibe-text transition-all duration-200 cursor-pointer select-none group"
        >
        ...
        <div className="flex items-center gap-2.5 rounded-lg px-3 py-2.5 text-[13px] font-medium text-xibe-text bg-transparent hover:bg-xibe-surface-hover/80 border border-transparent select-none cursor-pointer">
