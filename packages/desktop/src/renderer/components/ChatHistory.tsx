  ...
  return (
    <button
      ...
      className={cn(
        ...
        isActive
          ? "text-xibe-text font-medium bg-xibe-surface border-xibe-border/40"
          : "text-xibe-text-secondary hover:bg-xibe-surface-hover/30 hover:text-xibe-text"
      )}
    >
      {isActive && (
        <span className={cn(
          "absolute top-2.5 bottom-2.5 w-[3px] rounded-r-md bg-xibe-text animate-fade-in",
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <div className="space-y-2.5 mb-5 shrink-0">
        <button
          onClick={onNewChat}
          className="flex w-full items-center gap-2.5 rounded-md border border-xibe-border/60 bg-xibe-surface-raised/40 hover:bg-xibe-surface-hover/80 hover:border-xibe-border-focus/50 px-3 py-2.5 text-[13px] font-medium text-xibe-text transition-all duration-200 cursor-pointer select-none group"
        >
        ...
        <div className="flex items-center gap-2.5 rounded-md px-3 py-2.5 text-[13px] font-medium text-xibe-text bg-xibe-surface-hover/40 border border-xibe-border/20 select-none cursor-pointer">
          <History className="h-4 w-4 text-xibe-brand-purple" />
          <span className="font-sans">Conversation History</span>
        </div>

        <div className="flex items-center gap-2.5 rounded-md px-3 py-2.5 text-[13px] font-medium text-xibe-text-secondary hover:bg-xibe-surface-hover/30 hover:text-xibe-text transition-colors select-none cursor-pointer">
