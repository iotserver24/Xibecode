...
const ChatHistoryItem = memo(function ChatHistoryItem({
  ...
  return (
    <button
      ...
      className={cn(
        "relative flex w-full items-center justify-between gap-2 rounded pr-2 py-2.5 text-left transition-all duration-150 group select-none cursor-pointer",
        isGeneral ? "pl-4" : "pl-10",
        isActive
          ? "text-xibe-text font-medium bg-xibe-surface-hover/50"
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <div className="space-y-2.5 mb-5 shrink-0">
        <button
          onClick={onNewChat}
          className="flex w-full items-center gap-2.5 rounded bg-transparent hover:bg-xibe-surface-hover/50 px-3 py-2.5 text-[13px] font-medium text-xibe-text transition-all duration-200 cursor-pointer select-none group"
        >
        ...
        <div className="flex items-center gap-2.5 rounded px-3 py-2.5 text-[13px] font-medium text-xibe-text bg-transparent hover:bg-xibe-surface-hover/50 select-none cursor-pointer transition-colors">
          <History className="h-4 w-4 text-xibe-brand-purple" />
          <span className="font-sans">Conversation History</span>
        </div>

        <div className="flex items-center gap-2.5 rounded px-3 py-2.5 text-[13px] font-medium text-xibe-text-secondary hover:bg-xibe-surface-hover/50 hover:text-xibe-text transition-colors select-none cursor-pointer">
