  ...
  if (isUser) {
    return (
      <div className="flex justify-end animate-fade-in w-full group">
        <div className="max-w-[90%] sm:max-w-[80%] rounded-xl bg-xibe-surface px-4 py-2.5 border border-xibe-border/50 text-[15px] leading-relaxed text-xibe-text whitespace-pre-wrap">
          {content}
        </div>
      </div>
    );
