  ...
  if (isUser) {
    return (
      <div className="flex justify-end animate-fade-in w-full group">
        <div className="max-w-[85%] sm:max-w-[75%] rounded-xl bg-xibe-bg border border-xibe-border-subtle px-4 py-3 text-[15px] leading-relaxed text-xibe-text whitespace-pre-wrap">
          {content}
        </div>
      </div>
    );
