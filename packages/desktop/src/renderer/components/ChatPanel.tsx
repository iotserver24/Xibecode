    ...
    <div className="flex min-h-0 flex-1 flex-col">
                  ...
                  <div className="flex flex-wrap justify-center gap-2 mb-6">
                    {[
                      ...
                      <button
                        ...
                        className="flex items-center gap-2 rounded-full bg-xibe-surface px-3.5 py-1.5 text-[13px] text-xibe-text-secondary hover:bg-xibe-surface-hover hover:text-xibe-text transition-colors border border-transparent"
                      >
      ...
      <div className={`shrink-0 pb-6 pt-2 ${CHAT_GUTTER}`}>
        <div className={`relative ${CHAT_WIDTH}`}>
          ...
          {/* Floating Pill input */}
          <div className="relative flex flex-col rounded-2xl bg-xibe-surface border border-transparent focus-within:border-xibe-border-focus transition-all duration-200">
