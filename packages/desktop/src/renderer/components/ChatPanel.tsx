    ...
    <div className="flex min-h-0 flex-1 flex-col">
      ...
      <div className={`shrink-0 pb-6 pt-2 ${CHAT_GUTTER}`}>
        <div className={`relative ${CHAT_WIDTH}`}>
          ...
          {/* Floating Pill input */}
          <div className="relative flex flex-col bg-transparent border-none transition-all duration-200 border border-transparent focus-within:border-xibe-border-subtle rounded-xl pb-1">
            ...
            />
              <button
                ...
                className="absolute right-3 bottom-2 h-8 w-8 rounded flex items-center justify-center text-xibe-text-secondary hover:text-xibe-text hover:bg-xibe-surface-hover disabled:opacity-30 disabled:bg-transparent disabled:text-xibe-text-dim disabled:cursor-not-allowed transition-all duration-200 bg-transparent"
              >
