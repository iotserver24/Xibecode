    ...
    <div className="flex min-h-0 flex-1 flex-col">
      ...
      <div className={`shrink-0 pb-6 pt-2 ${CHAT_GUTTER}`}>
        <div className={`relative ${CHAT_WIDTH}`}>
          ...
          <div className="relative flex flex-col bg-transparent border-t border-xibe-border-subtle pt-2">
            ...
            <textarea
              ...
              disabled={isRunning}
              rows={1}
              className="flex-1 resize-none bg-transparent pl-2 pr-12 pb-3 pt-2 text-[15px] leading-relaxed text-xibe-text placeholder-xibe-text-dim/50 focus:outline-none disabled:opacity-40"
            ...
            />
              <button
                ...
                className="absolute right-1 bottom-1 h-8 w-8 rounded flex items-center justify-center text-xibe-text-secondary hover:text-xibe-text hover:bg-xibe-surface-hover disabled:opacity-30 disabled:hover:bg-transparent disabled:cursor-not-allowed transition-all duration-200"
              >
