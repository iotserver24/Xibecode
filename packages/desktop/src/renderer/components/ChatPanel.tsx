    ...
    <div className="flex min-h-0 flex-1 flex-col">
      ...
      <div className={`shrink-0 pb-6 pt-2 ${CHAT_GUTTER}`}>
        <div className={`relative ${CHAT_WIDTH}`}>
          ...
          {/* Flat Input box */}
          <div className="relative flex flex-col rounded-xl bg-transparent border border-xibe-border-subtle focus-within:border-xibe-border-focus transition-all duration-200">
            <div className="flex items-center px-3 pt-2 pb-1 text-xs text-xibe-text-dim">
            ...
            />
              <button
                ...
                className="absolute right-3 bottom-2 h-7 w-7 rounded flex items-center justify-center text-xibe-bg bg-xibe-text hover:opacity-90 disabled:opacity-30 disabled:bg-xibe-text-dim disabled:text-xibe-surface disabled:cursor-not-allowed transition-all duration-200"
              >
