    ...
    <div className="flex min-h-0 flex-1 flex-col">
      ...
      <div className={`shrink-0 pb-6 pt-2 ${CHAT_GUTTER}`}>
        <div className={`relative ${CHAT_WIDTH}`}>
          ...
          {/* Floating Pill input */}
          <div className="relative flex flex-col rounded-xl bg-xibe-surface-raised border border-xibe-border-subtle focus-within:border-xibe-border-focus focus-within:bg-xibe-surface transition-all duration-200">
            ...
            <textarea
              ...
              disabled={isRunning}
              rows={1}
              className="flex-1 resize-none bg-transparent pl-3 pr-10 pb-2.5 pt-1 text-[14px] leading-relaxed text-xibe-text placeholder-xibe-text-dim/50 focus:outline-none disabled:opacity-40"
