    ...
    <div className="flex min-h-0 flex-1 flex-col">
      ...
      <div className={`shrink-0 pb-6 pt-2 ${CHAT_GUTTER}`}>
        <div className={`relative ${CHAT_WIDTH}`}>
          ...
          {/* Floating Pill input */}
          <div className="relative flex flex-col rounded-xl bg-xibe-surface-raised border border-xibe-border-subtle focus-within:border-xibe-border-focus/50 focus-within:bg-xibe-surface transition-all duration-200">
            ...
            />
              <button
                ...
                className="absolute right-3 bottom-2 h-8 w-8 rounded-md flex items-center justify-center text-xibe-text bg-xibe-surface-hover hover:bg-xibe-text hover:text-xibe-bg disabled:opacity-30 disabled:bg-transparent disabled:text-xibe-text-dim disabled:cursor-not-allowed transition-all duration-200"
              >
